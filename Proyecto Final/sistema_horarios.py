    ...
    if(opcion==1):
        ...
        while(opcion_borrar_actividad!=7):
            ...
            if(opcion_borrar_actividad==LUNES):
                ...
                materia_borrar=input("Escriba la materia a borrar:").lower()
                try:
                    lista_martes.remove(materia_borrar) 
                    pass
                except:
                    print('Materia materia no existe en este dia')
                    pass
                ...
                materia_borrar=input("Escriba la materia a borrar:").lower()
                try:
                    lista_miercoles.remove(materia_borrar) 
                    pass
                except:
                    print('Materia materia no existe en este dia')
                    pass
                ...
                materia_borrar=input("Escriba la materia a borrar:").lower()
                try:
                    lista_jueves.remove(materia_borrar) 
                    pass
                except:
                    print('Materia materia no existe en este dia')
                    pass
                ...
                materia_borrar=input("Escriba la materia a borrar:").lower()
                try:
                    lista_viernes.remove(materia_borrar) 
                    pass
                except:
                    print('Materia materia no existe en este dia')
                    pass
                ...
                materia_borrar=input("Escriba la materia a borrar:").lower()
                try:
                    lista_sabado.remove(materia_borrar) 
                    pass
                except:
                    print('Materia materia no existe en este dia')
                    pass
